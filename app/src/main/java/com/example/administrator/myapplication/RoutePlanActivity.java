...
import com.example.administrator.overlayutil.BikingRouteOverlay;
import com.example.administrator.overlayutil.DrivingRouteOverlay;
import com.example.administrator.overlayutil.OverlayManager;
import com.example.administrator.overlayutil.TransitRouteOverlay;
import com.example.administrator.overlayutil.WalkingRouteOverlay;
...
public class RoutePlanActivity extends Activity
    ...
    public void searchButtonProcess(View v) {
        ...
        if(editSt.getText().toString()==mlocation){
            editSt.setText(mlocation);
        }
